<template>
    <footer class="py-5">
        <div class="container d-flex algin-tiems-center justify-content-between">
            <div class="left d-flex align-items-center">
                <div class="h-100 d-flex align-items-start flex-column justify-content-between">
                    <svg class="logo" xmlns="http://www.w3.org/2000/svg" width="139" height="20">
                        <defs>
                        ...
                        <g class="text" fill="none" fill-rule="evenodd">
                    ...
                    <div class="socials d-flex align-items-center gap-3">
                        ...
                        <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="21" height="18">
                            <path fill="#FFF"
                ...
                <div class="links d-flex align-items-center">
                    <ul class="d-flex align-items-start gap-3 flex-column">
                        <li>About Us</li>
                        <li>Contact</li>
                        <li>Blog</li>
                    </ul>
            ...
            <div class="right d-flex align-items-end flex-column justify-content-between">
                <button class="butn">Request Invite</button>
                <span class="copy-right">&copy; Easybank. All Rights Reserved</span>
            </div>
        </div>
    </footer>
</template>
